...
the `hipDF <https://github.com/AMD-Ecosystem/hipDF>`_ library enables DataFrames that
...
`https://github.com/AMD-Ecosystem/hipDF <https://github.com/AMD-Ecosystem/hipDF>`_.
