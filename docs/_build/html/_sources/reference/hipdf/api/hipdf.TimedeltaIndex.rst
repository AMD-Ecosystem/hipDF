...
.. autoclass:: TimedeltaIndex
   ...
   .. autosummary::
      ...
      ~TimedeltaIndex.ceil
      ~TimedeltaIndex.copy
      ~TimedeltaIndex.deserialize
      ~TimedeltaIndex.device_deserialize
      ~TimedeltaIndex.device_serialize
      ...
      ~TimedeltaIndex.find_label_range
      ~TimedeltaIndex.floor
      ~TimedeltaIndex.from_arrow
      ~TimedeltaIndex.from_pandas
      ~TimedeltaIndex.from_pylibcudf
      ~TimedeltaIndex.get_indexer
      ~TimedeltaIndex.get_level_values
      ~TimedeltaIndex.get_loc
      ~TimedeltaIndex.get_slice_bound
      ~TimedeltaIndex.host_deserialize
      ~TimedeltaIndex.host_serialize
      ...
      ~TimedeltaIndex.sum
      ~TimedeltaIndex.take
      ~TimedeltaIndex.to_arrow
      ~TimedeltaIndex.to_cupy
      ~TimedeltaIndex.to_dlpack
      ~TimedeltaIndex.to_frame
      ~TimedeltaIndex.to_list
      ~TimedeltaIndex.to_numpy
      ~TimedeltaIndex.to_pandas
      ~TimedeltaIndex.to_pylibcudf
